...
**Process Lasso:** Using this program, you can force apps to run in a specified priotity, as well as adjusted core affinity according to your system. [DOWNLOAD](https://bitsum.com/) 
