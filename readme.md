...
## Steam Launch Options
  - `-threads x` Adjust the amount of threads the game uses. Replace with your thread count -1 or try half your thread count. You can open Task Manager and check your core count there.
